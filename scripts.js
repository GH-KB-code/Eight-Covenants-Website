...
const covenantData = [
    {
        id: 'covenant1',
        title: 'Edenic Covenant',
        imgSrc: 'https://miro.medium.com/v2/resize:fit:2000/1*rJ36ymwzBt1IJyHyMcSfHQ.jpeg',
        description: `
        ...
        However, this covenant had one condition: they were to remain obedient to God's command and not eat from the tree of 
        the knowledge of good and evil. This was not a cruel restriction but a safeguard for their relationship with God. 
...

    {
        ...
        imgSrc: 'https://edge.mcsw.net/mcsweeneys/17351jn22j6xbstkty8plqoygpm7',
        description: `
            <p><strong> Genesis 2:15-17</strong></p>
            
            <p>"The Lord God took the man and put him in the garden of Eden to work it and keep it. 
            ...
            This covenant brought the reality of consequences for
            disobedience: pain in childbirth for Eve, a cursed ground for Adam, hard
            work, and spiritual death for both. However, even in the midst of judgment,
    ...
    },
    {
        ...
        imgSrc: 'https://en.brightchurch-it.org/wp-content/uploads/2019/07/002-%E6%8C%AA%E4%BA%9A%E4%B8%80%E5%AE%B6%E5%85%AB%E5%8F%A3%E7%9C%8B%E5%88%B0%E5%BD%A9%E8%99%B9%E6%AC%A2%E5%91%BC%E9%9B%80%E8%B7%83-ZB-20171208.jpg',
        description: `
            <p><strong> Genesis 8:20 - 9:17 </strong></p>

            <p>"Then Noah built an altar to the Lord and took some of every clean animal and some of every clean bird and offered burnt 
            offerings on the altar. And when the Lord smelled kthe pleasing aroma, the Lord said in his heart, “I will never again curse
             the ground because of man, for mthe intention of man’s heart is evil from his youth. Neither will I ever again strike down 
            ...
            This covenant was a promise that God would never again destroy the earth with a flood. 
            The rainbow became the symbol of the covenant, the visible sign of God’s faithfulness to His promise. 
    ...
    },
    {
        ...
        imgSrc: 'https://static.wixstatic.com/media/00f46b_7e80f9161e114ac8bf1e9912cad519ad~mv2.jpg/v1/fill/w_926,h_509,al_c,lg_1,q_85/00f46b_7e80f9161e114ac8bf1e9912cad519ad~mv2.jpg',
        description: `  
            <p><strong> Genesis 12:1-3 </strong></p>

            <p> “Now the Lord said to Abram, ‘Go from your country and your kindred and your father’s house to the land that I will show you. 
...

    {
        ...
        imgSrc: 'https://91b6be3bd2294a24b7b5-da4c182123f5956a3d22aa43eb816232.ssl.cf1.rackcdn.com/contentItem-10637658-97768736-bh0x8w0hxlm35-or.png',
        description: `
                    <p><strong>  Exodus 19:1-6 </strong></p>
                    <p>
                     ...
                     while Moses went up to God. The LORD called to him out of the mountain, saying, "Thus you shall say to the house of Jacob, and tell the 
                     people of Israel: You yourselves have seen what I did to the Egyptians, and how I bore you on eagles' wings and brought you to myself. 
                     ...
                     for all the earth is mine; and you shall be to me a kingdom of priests and a holy nation. These are the words that you shall speak 
                    ...
                    At Mount Sinai, God gave the law to Moses, which included the Ten Commandments and a detailed system of laws for Israel to follow.
                     ...
                     It highlighted God’s holiness and the need for purity and obedience. 
    ...
    },
    {
        ...
        description: `
                    <p><strong> Jeremiah 23:5 </strong></p>

                    <p>“Behold, the days are coming,” says the LORD, “ That I will raise to David a Branch of righteousness; 
    ...
    
    {
        ...
        description: `
                        ...
                        <p>“Behold, the days are coming, declares the Lord, when I will make a new covenant with the house of Israel 
                        and the house of Judah, not like the covenant that I made with their fathers on the day when I took them by the hand 
                        to bring them out of the land of Egypt, my covenant that they broke, though I was their husband, declares the Lord. 
                        For this is the covenant that I will make with the house of Israel after those days, declares the Lord: I will put my 
...
function renderCovenantList() {
    const listContainer = document.getElementById('covenantList');
    listContainer.innerHTML = ''; // Clear the current content

    covenantData.forEach((covenant, index) => {
        const li = document.createElement('li');
        li.classList.add('covenant-item');
        li.setAttribute('onclick', `showCovenantDetails(${index})`);

        const div = document.createElement('div');
        div.classList.add('circle');
        const img = document.createElement('img');
        img.src = covenant.imgSrc;
        img.alt = covenant.title;
        div.appendChild(img);

        const h3 = document.createElement('h3');
        h3.textContent = covenant.title;
...
function showCovenantDetails(index) {
    const detailsSection = document.getElementById('details');
    const detailsDiv = document.getElementById('covenantDetails');
    const covenant = covenantData[index];

    detailsDiv.innerHTML = `
        <h3>${covenant.title}</h3>
        <p>${covenant.description}</p>
        ${covenant.audioSrc ? `<button class="audio-button" onclick="playAudio(${index})">Click to Hear My Voice</button>` : ''}
        <audio id="audio${index}" src="${covenant.audioSrc}"></audio>
    `;
